...
namespace StrixLibrary_Test
{
    public class CManagerPooling_Test
    {
        ...
        public void NormalClass_PoolTest()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                PoolingObjectTest pPoolObject = CManagerPooling_NormalClass<PoolingObjectTest>.instance.DoPop(pPoolingOrigin);
            ...
            CManagerPooling_NormalClass<PoolingObjectTest>.instance.DoPushAll();
            ...
            Assert.AreEqual(CManagerPooling_NormalClass<PoolingObjectTest>.instance.p_iInstanceCount, 10); // 최대 생성 수는 10번이다.
